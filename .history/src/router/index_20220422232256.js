...
import  check_profile from '@/components/Parent/check_profile.vue';
...
const routes = [
  ...
  { path: '/login_bs', component: login_bs, name: 'login_bs',props : true },
  { path: '/check_profile', component: check_profile, name: 'check_profile',props : true },
]
