                  ...
                  <div class="card-body">
                    <div class="media g-mb-30 media-comment">
                      ...
                      >
                        ...
                        <div>
                          <label for="photo"><b>Add a review</b></label>

                          <input
                            type="text"
                              v-model="  v-model="addTeacherForm.lastName""
                            placeholder="write your review"
                            name="photo"
                            required
                          />

                          <button v-on:click="addReview" class="button1">
                            Add
                          </button>
                        </div>
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("user") != "null") {
      axios
        .get(
          "http://localhost:5000/api/babysitter/" + this.$route.params.username
        )
      ...
      axios
        .get("http://localhost:5000/api/review/" + this.$route.params.username)
        .then((response) => {
  ...
  methods: {
    addReview(){
       axios
        .post("http://localhost:5000/api/review/" + this.$route.params.username,this.reviewsForm)
