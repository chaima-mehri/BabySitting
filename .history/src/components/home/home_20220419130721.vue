      ...
      <div class="card-cart-container">
        <div class="card-container">
          <div v-for="(BabySitters, index) in filteredList" :key="index" class="card">
            ...
            <div class="card-text">
              <h3>{{ BabySitters.username }} {{BabySitters.lastName}}</h3>
            ...
            <div class="card-icons">
              <div class="like-container">
                <input
                  type="checkbox"
                  :value="BabySitters.id"
                  name="checkbox"
                  v-bind:id="BabySitters.id"
                  v-model="liked"
                  @click="setLikeCookie"
                />
                <router-link :to="{ name: 'profile_bs' }">
                  <i class="fa fa-eye"></i>
                  </router-link>
            ...
            <transition-group name="item-anim" tag="div" class="item-group">
              ...
              >
                ...
                <div class="item-description">
                  <h4>{{ BabySitters.username }} {{BabySitters.lastName}}</h4>
  ...
  computed: {
    ...
    filteredList() {
       return this.BabySitters.filter((sendbackBabySitters) => {
        return sendbackBabySitters.address
          ?.toLowerCase()
