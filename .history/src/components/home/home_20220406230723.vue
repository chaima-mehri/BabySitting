      ...
      <div class="card-cart-container">
        <div class="card-container">
          <div v-for="(BabySitters, index) in filteredList" :key="index" class="card">
            ...
            <div class="card-text">
              <h3>{{ BabySitters.firstName }} {{BabySitters.title}}</h3>
              <h4>{{ BabySitters.category }}</h4>
              <span>{{ BabySitters.entry_price }}€</span>
            </div>
            ...
            <transition-group name="item-anim" tag="div" class="item-group">
              ...
              >
                ...
                <div class="item-description">
                  ...
                  <p>{{ BabySitters.entry_price }}€</p>
                </div>
                <div class="item-quantity">
                  <h6>nombre place : {{ BabySitters.nbr_places }}</h6>
  ...
  methods: {
    ...
    addToCart(BabySitters) {
      ...
      this.cart.push({
        ...
        entry_price: BabySitters.entry_price,
        nbr_places: 1,
      });
    },
    cartPlusOne(BabySitters) {
      BabySitters.nbr_places = BabySitters.nbr_places + 1;
    },
    cartMinusOne(BabySitters, idBabySitters) {
      if (BabySitters.nbr_places == 1) {
