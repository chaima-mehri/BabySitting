        ...
        <div class="card-container">
          <div v-for="(BabySitters, index) in filteredList" :key="index" class="card">
            <div class="img-container">
              <img v-bind:src="BabySitters.image_data" />
            </div>
            <div class="card-text">
            ...
            <div class="card-icons">
              <div class="like-container">
                ...
                />
                  ...
                  <i v-on:click="seeProfile(BabySitters.username)" class="fa fa-eye"></i>
              ...
              <div class="grand-total">
                ...
                <label for="label"><b>Add note</b></label>
                  ...
                  />
                     ...
                     <button v-on:click="sendOffer(BabySitters.nbr_heures,BabySitters.nbr_heures,BabySitters.username)" class="button1">Add</button>
              </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    addToCart(BabySitters) {
      ...
      this.cart.push({
        date: BabySitters.date,
        city: BabySitters.city,
        id: BabySitters.id,
        username:BabySitters.username,
        
        image_data: BabySitters.image_data,
    ...
    cartRemoveItem(id) {
      this.$delete(this.cart, id);
       ...
       sendOffer(cartTotalAmount,id,username){
         this.OfferForm.id_babysitter=this.cart['id'];
         this.OfferForm.duration=cartTotalAmount;
         this.OfferForm.BabySitter=username;
         axios.post("http://localhost:5000/api/offer/"+localStorage.getItem('id'),this.OfferForm)
         .then((response) => {
