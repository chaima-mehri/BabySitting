                  ...
                  <div class="card-body">
                    <div class="media g-mb-30 media-comment">
                      ...
                      >
                        ...
                        <div class="g-mb-15"  v-for="review in review" :key="review.id">
                          <h5 class="h5 g-color-gray-dark-v1 mb-0">{{review.sender}}</h5>
...
.g-bg-secondary {
  background-color: #99bfa125 !important;
}

.u-shadow-v18 {
  box-shadow: 0 5px 10px -6px rgba(0, 0, 0, 0.035);
}
