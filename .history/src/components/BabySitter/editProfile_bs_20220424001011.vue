...
export default {
  ...
  document.getElementById("myImg").src=URL.createObjectURL(this.Images)
  localStorage.setItem('image',URL.createObjectURL(this.Images))
  this.file.file=URL.createObjectURL(this.Images)
    ...
    changeImage(){
      const formData = new FormData();
        ...
        console.log("try trah ",this.Images,URL.createObjectURL(this.Images))
        
      axios.post("http://localhost:5000/uploadImageTest/"+localStorage.getItem('user'),URL.createObjectURL(this.Images), { headers })
      .then((response) => {
